...
<div className="grid grid-rows-5 grid-flow-col gap-10 max-w-fit">

    <div className="row-span-3 py-1 h-fit">
        <img src={HERO} alt={'Hero'}/>
    </div>

    <div className={"col-start-2 row-span-3 self-center max-w-lg h-fit"}>
                    <span className={"text-5xl font-bold"}>
                        Affordable Mental Health for{" "}
                        <span className={"text-secondary_4"}>Everyone.</span>
                    </span>
